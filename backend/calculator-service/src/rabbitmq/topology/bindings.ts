...
export const Bindings = [
  {
    ...
    queue: Queues.ADDITION,
    routingKey: RoutingKeys.ADD,
  },

  {
    exchange: Exchanges.CALCULATION,
    queue: Queues.SUBTRACTION,
    routingKey: RoutingKeys.SUB,
  },

  {
    exchange: Exchanges.CALCULATION,
    queue: Queues.MULTIPLICATION,
    routingKey: RoutingKeys.MUL,
  },
